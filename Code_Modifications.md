...
5. **USPSShippingQuote.java**
   - Replaced `getAdminFormatedAmount` with `getStoreFormatedAmountWithCurrency` in the method `getShippingQuotes`.

6. **ProductPriceUtils.java**
   - Made the method `getStoreFormatedAmountWithCurrency` static.